	...
	s.Router.Route("/api/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/chat", func(r chi.Router) {
				...
				r.Get("/threads/{id}/pin", chatHandler.GetPin)
			...
			r.Route("/databases", func(r chi.Router) {
				...
				r.Post("/import", databasesHandler.ImportCSV)
				...
				r.Get("/tables/{tableId}/export", databasesHandler.ExportTableCSV)
			...
			r.Route("/notifications", func(r chi.Router) {
				...
				r.Put("/{id}/unread", notificationsHandler.MarkUnread)
				r.Put("/{id}/restore", notificationsHandler.Restore)
				r.Post("/{id}/open-chat", notificationsHandler.OpenAsChat)
