            ...
            {filteredRoles.length === 0 ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <Card
                    hover
                    onClick={() => navigate("/agents/gateway")}
                  >
                    ...
                    <div className="flex items-center gap-4 mb-3">
                      <div className="relative flex-shrink-0">
                        <img
                          src={builderRole?.avatar_path || "/gateway-avatar.png"}
                          alt={gatewayName}
                      ...
                      <h3 className="text-xl font-bold text-text-0">
                        {gatewayName}
                      </h3>
                    </div>
                    <p className="text-sm text-text-2 line-clamp-1 mb-3 leading-snug">
                      Routes conversations, builds tools, dashboards, and
                      agents
                    </p>
                  ...
                  {paginatedRoles.map((role) => (
                    <Card
                      key={role.slug}
                      hover
                      onClick={() => navigate(`/agents/${role.slug}`)}
                    >
                      <div className="flex items-center gap-2 mb-3">
                        {role.library_slug && (
                    ...
                    <div className="flex items-center gap-3 md:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <p className="text-base font-bold pt-2 text-text-0 truncate">
                            {gatewayName}
                          </p>
                          <span className="text-[10px] px-1.5 py-0.5 rounded bg-accent-primary/15 text-accent-primary flex-shrink-0">
                            Gateway
                          </span>
                        </div>
                    ...
                    >
                      <div className="flex items-center gap-3 md:gap-4">
                        <img
                          src={role.avatar_path}
                          alt={role.name}
                          className="w-10 h-10 md:w-12 md:h-12 rounded-xl flex-shrink-0"
                        />
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <p className="text-base font-bold pt-2 text-text-0 truncate">
                        ...
                        <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0">
                          {!role.is_preset && (
                            <button
                              onClick={(e) =>
                                deleteRole(role.slug, role.name, e)
                              }
