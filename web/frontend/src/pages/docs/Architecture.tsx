...
│   ├── toollibrary/      # Service catalog and management
...
└── 023_agent_library.sql`}</code></pre>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>tools</code></td><td>Installed services and their status</td></tr>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>/api/tools</code></td><td>CRUD + start/stop</td><td>Service management</td></tr>
...
{ "type": "stream", "payload": { "event": { "type": "result", "total_cost_usd": 0.003 } } }`}</code></pre>
      ...
      <ul>
        ...
        <li><strong>Service Integrity</strong> — SHA-256 hashes verify service binaries haven&apos;t been modified</li>
