...
const useCases = [
  ...
  },
  {
    ...
    examples: [
      ...
      'Install the GitHub service to let agents create issues, review PRs, and check CI status',
      'Set up scheduled code quality reports that run nightly',
      'Build a custom service to monitor staging deployments and report status',
    ],
  ...
  },
  {
    ...
    examples: [
      'Create a "Research Analyst" agent with access to search and academic services',
      'Install Semantic Scholar and ArXiv services for academic paper access',
      'Set up automated literature reviews that run weekly',
      'Build custom services to pull data from external APIs and analyze trends',
    ],
  ...
  },
  {
    ...
    description: 'Automate repetitive tasks with scheduled jobs, heartbeat monitoring, and service integrations.',
    examples: [
      'Schedule a daily service action to check system health and report via notifications',
      ...
      'Build custom services to fetch reports and monitor dashboards on a schedule',
    ],
...
export function UseCases() {
  ...
  return (
    <>
      ...
      <p>
        The combination of customizable agents, installable services, and scheduled automation
      ...
      {useCases.map((useCase) => (
        <div key={useCase.id}>
          ...
          <div className="flex flex-wrap gap-4 my-4 not-prose">
            ...
            <div>
              <p className="text-xs font-semibold text-text-3 uppercase tracking-wider mb-1.5">Useful Services</p>
              <div className="flex flex-wrap gap-1.5">
      ...
      <p>
        ...
        with the appropriate services. As you get comfortable, add more agents and automate with
        the scheduler.
      </p>
      <p>
