  ...
  return (
    <>
      ...
      <p className="text-lg text-text-2 mb-8">
        ...
        AI agents, services, and automations — all from a single Go binary.
      </p>
      ...
      <p>
        ...
        configure, and orchestrate AI agents. Each agent can have its own personality, services, and
