...
const ACTION_TYPES = [
  ...
  { value: 'tool_created', label: 'Service Created' },
  { value: 'tool_updated', label: 'Service Updated' },
  { value: 'tool_called', label: 'Service Called' },
  { value: 'tool_enabled', label: 'Service Enabled' },
  { value: 'tool_disabled', label: 'Service Disabled' },
  { value: 'tool_deleted', label: 'Service Deleted' },
  { value: 'tool_compiled', label: 'Service Compiled' },
  { value: 'tool_started', label: 'Service Started' },
  { value: 'tool_stopped', label: 'Service Stopped' },
  { value: 'tool_restarted', label: 'Service Restarted' },
