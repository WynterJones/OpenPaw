...
const CATEGORIES = [
  ...
  { value: 'tool', label: 'Microservices' },
...
const ACTION_TYPES = [
  ...
  { value: 'tool_created', label: 'Microservice Created' },
  { value: 'tool_updated', label: 'Microservice Updated' },
  { value: 'tool_called', label: 'Microservice Called' },
  { value: 'tool_enabled', label: 'Microservice Enabled' },
  { value: 'tool_disabled', label: 'Microservice Disabled' },
  { value: 'tool_deleted', label: 'Microservice Deleted' },
  { value: 'tool_compiled', label: 'Microservice Compiled' },
  { value: 'tool_started', label: 'Microservice Started' },
  { value: 'tool_stopped', label: 'Microservice Stopped' },
  { value: 'tool_restarted', label: 'Microservice Restarted' },
